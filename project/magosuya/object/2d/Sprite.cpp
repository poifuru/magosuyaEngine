...
void Sprite::Initialize (Vector3 position, Vector2 size) {
	...
	sprite_.transform.scale = { 1.0f, 1.0f, 1.0f };
	sprite_.transform.rotate = { 0.0f, 0.0f, 0.0f };
	sprite_.transform.translate = position;
...
void Sprite::ShowImGuiEditor () {
	...
	ImGui::DragFloat3 ("spriteTranslate", &sprite_.transform.translate.x, 1.0f);
	ImGui::DragFloat2 ("UVScale", &sprite_.uvTransform.scale.x, 0.01f, -10.0f, 10.0f);
	ImGui::DragFloat2 ("UVRotate", &sprite_.uvTransform.rotate.x, 0.01f, -10.0f, 10.0f);
	ImGui::DragFloat ("UVTranslate", &sprite_.uvTransform.translate.z);
	ImGui::Separator ();
}