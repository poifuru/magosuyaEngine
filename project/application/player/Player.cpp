...
void Player::Initialize () {
	...
	transform_.translate = { -19.0f, -1.0f, 0.0f };
...
void Player::Update () {
	...
	ImGui::Text ("direction : %d", dir_);
	ImGui::Text ("isAir : %d", isAir_);
	ImGui::Text ("airJump : %d", airJump_);
	ImGui::Text ("isAvoid : %d", isAvoid_);
	ImGui::Text ("avoidTimer : %f", avoidTimer_);
	ImGui::Text ("avoidCoolTime : %f", avoidCoolTime_);
}
